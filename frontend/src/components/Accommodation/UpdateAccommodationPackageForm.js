...
export default function UpdateAccommodationPackageForm({ accommodationPackageId }) {
 // accommodationPackageId == "64682af8fcd36af9c3145bae";
  ...
  const fetchAccommodationPackage = async () => {
    try {
      const response = await axios.get(`http://localhost:5001/AccommodationPackage/get-AccommodationPackage/${id}`);
  ...
  const updateAccommodationPackage = async (e) => {
    ...
    try {
      await axios.put(`http://localhost:5001/AccommodationPackage/update-AccommodationPackage/${id}`, {
        package_title,
        Price_Range,
        package_description,
